...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mindcarter — Discover. Enable. Evolve." },
      {
        name: "description",
        content:
          "Premium psychology & organizational consulting. Research-backed therapy, assessments, executive coaching and enterprise wellness.",
      },
      { name: "author", content: "Mindcarter" },
      { property: "og:title", content: "Mindcarter — Discover. Enable. Evolve." },
      {
        property: "og:description",
        content:
          "Premium psychology & organizational consulting for individuals, leaders and enterprises.",
      },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className="max-w-full overflow-x-hidden">
      ...
      <body className="max-w-full bg-background text-foreground">
        {children}
        <Scripts />
      </body>
    </html>
